...
import { Fondos} from './sections/fondos-local';
import { Logos } from './sections/logos-local';
import Login from './Login';

window.addEventListener('load', ()=>{
  const container_loader = document.querySelector('.container_loader')
  container_loader.style.opacity = 100
...
DEFAULT_SECTIONS.splice(3, 0, Fondos);
DEFAULT_SECTIONS.splice(4, 0, Logos )
    ...
    <div>
      {isLoggedIn ?(
        ...
        <div
          ...
          onDrop={handleDrop}
        >
          <Topbar store={store} onLogout={handleLogout} /> 
